...
function ImageGallary() {
  ...
  return (
    <section
      id="gallery"
      className="py-16 md:py-24 bg-gray-50 rounded-lg shadow-md mx-4 mt-4"
    >
        ...
        <div className="relative w-full max-w-4xl mx-auto rounded-xl overflow-hidden shadow-lg">
          <img
            ...
            onError={(e) => {
              ...
              e.target.src = `https://placehold.co/800x500/CCCCCC/000000?text=Image+${
                currentIndex + 1
              }`;
            }}
          />
          ...
          <div className="relative bg-white rounded-lg shadow-xl max-w-4xl max-h-full overflow-auto">
            ...
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src =
                  "https://placehold.co/800x600/CCCCCC/000000?text=Image+Load+Error";
              }}
            />
          </div>
        </div>
